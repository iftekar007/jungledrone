...
/*
    ...
    $scope.signupFormsubmit =function(){
        ...
        $http({
            ...
            $scope.signupForm.$setUntouched(true);
            //$scope.signupForm.$pristine=true;
...
jungledrone.controller('header', function($scope,$state,$http,$cookieStore,$rootScope) {
    setTimeout(function(){
...
jungledrone.controller('employment', function($scope,$state,$http,$cookieStore,$rootScope) {
...
jungledrone.controller('editevent', function($scope,$state,$http,$cookieStore,$rootScope,$stateParams) {
